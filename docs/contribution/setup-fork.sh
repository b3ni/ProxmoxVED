...
# upstream   https://github.com/b3ni/ProxmoxVED.git (fetch)
# upstream   https://github.com/b3ni/ProxmoxVED.git (push)
```
...
print_info "Upstream: https://github.com/b3ni/ProxmoxVED"
echo ""
